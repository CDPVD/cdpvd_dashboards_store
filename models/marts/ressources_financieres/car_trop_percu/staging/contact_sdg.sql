...
with wide as (
    select
		...
		ele.nom, 
    	ele.pnom as prenom, 
		case when adr.type_contact = '3' then ele.nom end as nom_mere,
        case when adr.type_contact = '3' then ele.pnom end as pnom_mere,
        case when adr.type_contact = '2' then ele.nom end as nom_pere,
        case when adr.type_contact = '2' then ele.pnom end as pnom_pere,
        case when adr.type_contact = '4' then ele.nom end as nom_tuteur,
        case when adr.type_contact = '4' then ele.pnom end as pnom_tuteur, 
