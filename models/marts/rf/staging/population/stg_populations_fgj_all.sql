...
from {{ source_or_ref("populations", "stg_ele_prescolaire_all") }}
union
select code_perm, id_eco, annee, 'Primaire régulier' as population
from {{ source_or_ref("populations", "stg_ele_primaire_reg_all") }}
union
select code_perm, id_eco, annee, 'Primaire adapté' as population
from {{ source_or_ref("populations", "stg_ele_primaire_adapt_all") }}
union
select code_perm, id_eco, annee, 'Secondaire régulier' as population
from {{ source_or_ref("populations", "stg_ele_secondaire_reg_all") }}
union
select code_perm, id_eco, annee, 'Secondaire adapté' as population
from {{ source_or_ref("populations", "stg_ele_secondaire_adapt_all") }}
union
