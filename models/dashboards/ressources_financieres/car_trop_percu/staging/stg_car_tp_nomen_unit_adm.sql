...
select distinct
    coalesce(t2.new_lieu_trav, t1.code) as code, 
    upper(left(coalesce(t2.new_descr, t1.descr), 1)) + lower(substring(coalesce(t2.new_descr, t1.descr), 2, len(coalesce(t2.new_descr, t1.descr)))) as descr
