...
#}
{{ config(alias="indicateur_reussite_garcons") }}
...
with
    src as (
        select
            ...
            pevr_charl.cohorte,
            CONCAT(pevr_charl.annee_scolaire, ' (', pevr_charl.cohorte, ') ') as an_sco_cohorte,
            pevr_charl.taux,
            pevr_charl.cible
        ...
        where ind.id_indicateur_cdpvd = '2' -- 2 -Indicateur du taux des garçons
    )
