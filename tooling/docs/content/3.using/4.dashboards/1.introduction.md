...
| [Effectifs et réussites des élèves inscrits FP&FGA](/using/dashboards/educ-serv-adultes/predictive-aggregated) |Suivi des population définie au sein d'un centre de services scolaires. Le tableau de bord affiche le nombre total d'élèves dans chaque école, ainsi que les taux de réussite et les sanctions disciplinaires. | (CSST) Adama Fall	|