...
| [portrait_css_fpfg](/using/dashboards/educ-serv-adultes/portrait_css_fpfg) |Suivi des population définie au sein d'un centre de services scolaires. Le tableau de bord affiche le nombre total d'élèves dans chaque école, ainsi que les taux de réussite et les sanctions disciplinaires. | (CSST) Adama Fall, Mohamed Sadqi (CSSVDC), Martin Legault (CSSMV)|