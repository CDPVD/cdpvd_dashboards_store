...
with
    ...
    agg_dip as (
        select
            ...
            cast(avg(ind_obtention) as decimal(5, 2)) as taux_qualification_fpt,
            cast(((avg(ind_obtention)) - cible) as decimal(5, 2)) as ecart_cible,
            cible
        from _filtre
        group by
            annee_scolaire,
...
select
    ...
    nb_resultat,
    taux_qualification_fpt,
    CONCAT(taux_qualification_fpt * 100, ' (', nb_resultat, ' El.) ') AS taux_nbEleve,
    ecart_cible,
    cible,
    {{
