...
with
        ...
        select
            ...
            case
                ...
                then
                    right(
                        '0000000'
                        + left(code_emprunt, charindex('_', code_emprunt) - 1),
                        7
                    )
    ...
    tp as (
        ...
        where type_emprunt = '1' and date_annul is null and type_paiemnt = '4'
...
from car_tp as ct
inner join
    el_cast as el on cast(el.fiche_key as nvarchar) = cast(ct.fiche_key as nvarchar)
